...
echo '<div class="textopequeno">'.' '.$hlp[$f].$col[$f].$asterisco."<br>";
...
if ($tip[$f]=="image"){
echo '<hr>';
echo '<div class="textopequeno">'.' '.$hlp[$f].$col[$f].$asterisco."<br>";echo "<table width='100%' border='0'><tr><td width='50%'>";
$pete=$f+count($col)+1;
...
if ($tip[$f]=="number") {echo '<div class="textopequeno">'.' '.$hlp[$f].$col[$f].$asterisco."<br>"; echo '<input class="input-field" step="0.01" type="'.$tip[$f].'"  placeholder="'.$col[$f].'" '.$bloquear.' name="'.$f.'" value="'.$kaka[$f].'"'.$siosi.'>';}

if ($tip[$f]=="text") {echo '<div class="textopequeno">'.' '.$hlp[$f].$col[$f].$asterisco."<br>"; echo '<input class="input-field" type="'.$tip[$f].'"  placeholder="'.$col[$f].'" '.$bloquear.' name="'.$f.'" value="'.$kaka[$f].'"'.$siosi.'>';}

if ($tip[$f]=="url") {echo '<div class="textopequeno">'.' '.$hlp[$f].$col[$f].$asterisco."<br>"; echo '<input class="input-field" type="text"  placeholder="'.$col[$f].'" '.$bloquear.' name="'.$f.'" value="'.$kaka[$f].'"'.$siosi.'>';}

if ($tip[$f]=="date") {echo '<div class="textopequeno">'.' '.$hlp[$f].$col[$f].$asterisco."<br>"; echo '<input class="input-field" type="'.$tip[$f].'"  placeholder="'.$col[$f].'" '.$bloquear.' name="'.$f.'" value="'.$kaka[$f].'"'.$siosi.'>';}
if ($tip[$f]=="time") {echo '<div class="textopequeno">'.' '.$hlp[$f].$col[$f].$asterisco."<br>"; echo '<input class="input-field" type="'.$tip[$f].'"  placeholder="'.$col[$f].'" '.$bloquear.' name="'.$f.'" value="'.$kaka[$f].'"'.$siosi.'>';}
if ($tip[$f]=="password") {echo '<div class="textopequeno">'.' '.$hlp[$f].$col[$f].$asterisco."<br>"; echo '<input class="input-field" type="'.$tip[$f].'"  placeholder="'.$col[$f].'" '.$bloquear.' name="'.$f.'" value="'.$kaka[$f].'"'.$siosi.'>';}
...
<center>
<hr>
<input class="input-field" type="checkbox" name="eliminar"><font size="3" color="red">Eliminar registro</font>
<hr>
